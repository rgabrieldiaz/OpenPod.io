  ...
  return (
    <div className="relative min-h-screen bg-slate-950 overflow-hidden font-sans text-slate-100 selection:bg-purple-500/30 selection:text-purple-200">
      ...
      <main className="relative z-10 mx-auto max-w-5xl px-6 py-12 md:py-20 flex flex-col min-h-screen justify-between">
        ...
        {/* Content Body */}
        <div className="my-16 grid gap-10 md:grid-cols-12 items-start">
          ...
          <div className="md:col-span-7 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <a
                ...
                className="flex items-center gap-2 rounded-lg bg-slate-900/80 hover:bg-slate-900 px-4 py-2.5 text-sm font-medium border border-slate-800 hover:border-slate-700 transition duration-200"
              >
              ...
              {!isConnected ? (
                <div className="space-y-6 py-4">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-slate-400">Connect your browser wallet to interact with the Monad Testnet.</p>
                  </div>
                  ...
                  >
                    {isPending ? 'Connecting Wallet...' : 'Connect Browser Wallet'}
                  </button>
                  {connectError && (
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center py-2 border-b border-slate-800/50">
                      ...
                      <span className="text-sm font-mono text-slate-200">10143</span>
                    </div>
